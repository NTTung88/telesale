   ...
   async function handleLogin(e) {
    ...
    return (
        ...
        <form className="loginform">
            ...
            <br/>
            <h6>Tên đăng nhập</h6>
            <Input ref={nameRef} type="text" className="form-control" placeholder="Tên đăng nhập"/>
            <br/>
            <h6>Mật khẩu</h6>
            <Input ref={passwordRef} type="password" className="form-control" placeholder="Nhập mật khẩu của bạn"/>
            <br/><br/>
            <Button onClick={handleLogin}
             className="btn btn-primary loginbtn">
               {login.isLoading ? 
                    <Loading size={20} 
                 color="white"/> : "Đăng nhập"}
            </Button>
        </form>
        <div className="info">
